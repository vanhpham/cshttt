...
\node [ant, right=1.2cm of enc, yshift=1cm] (tx1) {};
\node [right=0.1cm of tx1, font=\footnotesize\bfseries] {Antenna 1 ($Tx_1$)};

\node [ant, right=1.2cm of enc, yshift=-1cm] (tx2) {};
\node [right=0.1cm of tx2, font=\footnotesize\bfseries] {Antenna 2 ($Tx_2$)};
...
% Draw paths to receiver (placed 5.5cm to the right of tx antennas)
\node [ant, shape border rotate=270, right=5.5cm of tx1, yshift=-1.0cm] (rx1) {};
...
\node [draw, black!40, fill=gray!2, rounded corners=2pt, below=1.8cm of enc, xshift=2.0cm, text width=16em, font=\scriptsize] (tablebox) {
